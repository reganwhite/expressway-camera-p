<html>
	<head>
		<div id="container-b" style="height: 400px; min-width: 310px; max-width: 1300px; width: 50%;"></div>
		<script>
			/*
			...
			*/
			...
			function reloadData(e) {
				...
				$.getJSON('get-history-count.php?type=out&start=' + Math.round(e.min) +
			...
			$.getJSON('get-history-count.php?type=out&callback=?', function (data) {
				
				// create chart
				Highcharts.stockChart('container-b', {
					chart: {
						type: 'spline',
						zoomType: 'x'
					},
